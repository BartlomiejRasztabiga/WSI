...
class NeuralNetwork:
    ...
    def train(self, inputs, expected_outputs, epoch_count):
        ...
        for it in range(epoch_count):
            ...
            print(f"epoch {it}, mse={mean_squared_error}")
...
def main():
    ...
    X_train = X[idx]
    Y_train = np.array([f(i) for i in X_train])
