...
class NeuralNetwork:
    ...
    def _backward_propagation(self, train_x: float, train_y: float):
        ...
        hidden_layer_activations = self._sigmoid(
        ...
        output_layer_bias_delta = self._mse_derivative(output_layer_activations, output_layer_activations_expected)
        ...
        hidden_layer_bias_delta *= self._sigmoid_derivative(hidden_layer_activations)
    ...
    def _run_sgd(self, train_inputs, train_outputs, learning_rate: float, batch_size: int):
        ...
        for batch_num in range(mini_batches_count):
            ...
            self._run_mini_batch(train_inputs, train_outputs, train_samples_indexes[start_index:end_index], learning_rate)
